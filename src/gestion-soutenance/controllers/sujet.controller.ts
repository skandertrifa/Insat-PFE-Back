...
import { Body, Controller, Get, Post, Put,Delete, Param, ParseIntPipe, Query, Req, UseInterceptors, UploadedFile, BadRequestException, UseGuards, Header} from '@nestjs/common';
import { SujetDtoUpdate } from '../dto/sujet.dto-updat';
import { FileInterceptor } from '@nestjs/platform-express';
import { editFichePropositionpfe, editFileNameRapporPfe, fichePropositionPfeFileFilter, rapportPfeFileFilter } from 'src/gestion-soutenance/utils/file-uploads.utils';
